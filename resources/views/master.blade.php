...
<head>
    ...
    <!-- Meta -->
    <meta name="description" content="Smart Coder lab">
    <meta name="author" content="Shafiul Islam">
    ...
    <link href="{{ asset('dashboard/assets/lib/ionicons/css/ionicons.min.css') }}" rel="stylesheet">
    <!-- DashForge CSS -->
...
<header class="navbar navbar-header navbar-header-fixed">
    ...
    <div id="navbarMenu" class="navbar-menu-wrapper">
        <div class="navbar-menu-header">
            ...
            <a id="mainMenuClose" href=""><i class="fa-solid fa-xmark"></i></a>
        ...
        <ul class="nav navbar-menu">
            ...
            <li class="nav-item with-sub">
                ...
                <ul class="navbar-menu-sub">
                    <li class="nav-sub-item"><a href="{{ route('dashboard.index') }}" class="nav-sub-link"><i
            ...
            <li class="nav-item with-sub">
                ...
                <ul class="navbar-menu-sub">
                    <li class="nav-sub-item"><a href="{{ route('dashboard.index') }}" class="nav-sub-link"><i
                                class="fa-light fa-server text-warning"></i> Dashboard </a></li>
            ...
            <li class="nav-item with-sub">
                ...
                <ul class="navbar-menu-sub">
                    <li class="nav-sub-item"><a href="{{ route('sale.index') }}" class="nav-sub-link"> Sales <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="{{ route('withdraw.index') }}" class="nav-sub-link"> Withdraw
                            <span class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="{{ route('report.index') }}" class="nav-sub-link"> Reports <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="#" class="nav-sub-link"> Service Orders <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                </ul>
            </li>
            ...
            <li class="nav-item with-sub">
                ...
                <ul class="navbar-menu-sub">
                    <li class="nav-sub-item"><a href="{{route('lufix')}}" class="nav-sub-link">LuFix Services <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="#" class="nav-sub-link">Shells <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="#" class="nav-sub-link">cPanels <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="#" class="nav-sub-link">RDPs <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="#" class="nav-sub-link">SSH/WHM <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="{{route('mailer')}}" class="nav-sub-link">Mailers <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="{{route('smtp')}}" class="nav-sub-link">SMTPs <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="{{route('lead')}}" class="nav-sub-link">Leads <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="{{route('card')}}" class="nav-sub-link">Cards <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="{{route('webmail')}}" class="nav-sub-link">Webmails <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="{{route('account')}}" class="nav-sub-link">Accounts <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="{{route('script')}}" class="nav-sub-link">Scripts/Programs <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="{{route('letter')}}" class="nav-sub-link">Scam Pages/Letters <span
                                class="badge badge-primary ml-2">256314</span></a></li>
                    <li class="nav-sub-item"><a href="{{route('tutorial')}}" class="nav-sub-link">Tutorials/Methods
                            <span class="badge badge-primary ml-2">256314</span></a></li>
                </ul>
            </li>
            ...
            {{-- <li class="nav-item with-sub">
              ...
              <ul class="navbar-menu-sub">
                ...
                <li class="nav-sub-item"><a href="#" class="nav-sub-link">Email Only <span class="badge badge-secondary ml-2">256314</span></a></li>
                <li class="nav-sub-item"><a href="#" class="nav-sub-link">Combo Email:Password <span class="badge badge-secondary ml-2">256314</span></a></li>
                <li class="nav-sub-item"><a href="#" class="nav-sub-link">Combo Username:Password <span class="badge badge-secondary ml-2">256314</span></a></li>
                <li class="nav-sub-item"><a href="#" class="nav-sub-link">Email Access <span class="badge badge-secondary ml-2">256314</span></a></li>
                <li class="nav-sub-item"><a href="#" class="nav-sub-link">Combo Email:Hash <span class="badge badge-secondary ml-2">256314</span></a></li>
                <li class="nav-sub-item"><a href="#" class="nav-sub-link">Phone Number Only <span class="badge badge-secondary ml-2">256314</span></a></li>
                <li class="nav-sub-item"><a href="#" class="nav-sub-link">Combo Phone:Password <span class="badge badge-secondary ml-2">256314</span></a></li>
    ...
    <div class="navbar-right">
        <a href="" class="search-link"><span class="badge badge-pill badge-primary"><i
                    class="fa-solid fa-plus mr-2"></i> 2560 $</span></a>
        ...
        <div class="dropdown dropdown-profile">
            ...
            <div class="dropdown-menu dropdown-menu-right tx-13">
                ...
                <a href="" class="dropdown-item"><i class="fa-light fa-user-pen"></i> Edit Profile</a>
                <a href="#" class="dropdown-item"><i class="fa-light fa-user"></i> View Profile</a>
                <div class="dropdown-divider"></div>
                <a href="#" class="dropdown-item"><i class="fa-light fa-basket-shopping-simple"></i> My Orders </a>
                <a href="" class="dropdown-item"><i class="fa-light fa-pen"></i> My Requests </a>
                <a href="" class="dropdown-item"><i class="fa-light fa-credit-card"></i> Add Balance</a>
...
<script src="{{ asset('dashboard/assets/lib/feather-icons/feather.min.js') }}"></script>
