                    ...
                    <div class="col-md-8 offset-md-2 mt-3">
                        <div class="card mt-3">
                            <div class="card-header">
                                <h3 class="text-center">Add Closed Service Order</h3>
                            </div>
                            <div class="card-body">
                                <form action="{{route('add.closed.service.order')}}" method="post" enctype="multipart/form-data">
                                    @csrf
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mt-3">
                        <div class="card mt-3">
                            <div class="card-header">
                                <h3 class="text-center">Closed Service Order Info</h3>
                            </div>
                            <div class="card-body">
