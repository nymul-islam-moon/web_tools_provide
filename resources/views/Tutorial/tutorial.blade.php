    ...
    <div class="container">
        <div class="row mt-5">
            <div class="button mb-4">
                ...
                <button class="btn btn-info">Added Tutorials/Methods</button>

                <button class="btn btn-info">Add Tutorials/Methods</button>
            </div>
                ...
                <div class="col-md-10">
                    <div class="card shadow border-0 rounded-lg mt-3">
                        <div class="card-header">
                            <h3 class="text-center font-weight-light my-2">Add Tutorials/Methods</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{route('saveTutorial')}}" method="post">
                                @csrf
            ...
            <table class="table table-bordered">
                ...
                @foreach ($tutorials as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('editTutorial',['id'=>$item->id])}}"
                               class="btn btn-primary btn-sm">Update</a>
                            <form action="{{route('deleteTutorial')}}" method="post">
                                @csrf
